...
% Configuration
	% Thesis title
	\newcommand{\thesisTitle}{\LARGE A Witnessing Annotation Framework for Low-Level Virtual Machine Compiler Infrastructure}
	% Thesis author
